 ...
 * on 2015-12-19 at 20:40:08 UTC 
 * Modify at your own risk.
 */

package com.example.duvernea.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1155.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.duvernea.myapplication.backend.myApi.model.MyBean> {
    ...
    protected GetJoke(java.lang.String joke) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.duvernea.myapplication.backend.myApi.model.MyBean.class);
  ...
  public class SayHi extends MyApiRequest<com.example.duvernea.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.duvernea.myapplication.backend.myApi.model.MyBean.class);
